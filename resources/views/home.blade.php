...
@section('content')
    <div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden mx-2">
        ...
        <img src="{{ Vite::asset('resources/images/dev.png') }}" alt=""
            class="absolute right-20 -bottom-20 opacity-20">
    </div>
    <div class='px-4'>
        <h1 class='text-2xl mb-8 text-gray-900'>Contenido técnico</h1>
        <div class='grid grid-cols-1 gap-4 mb-4'>
            @foreach ($posts as $post)
                <a href="{{ route('blog-detail', $post->slug) }}" class='bg-gray-100 rounded-lg px-6 py-4'>
